    ...
    <section class="ftco-section blog-section">
      <div class="container">
        ...
        <div v-else class="row">
          <div class="col-md-12 ftco-animate blog-card" v-for="blog in paginatedBlogs" :key="blog.id">
            <div class="blog-entry p-4 d-flex align-items-center">
              <div class="blog-image">
                <router-link :to="'/blog/' + blog.id" class="block-20" :style="{ backgroundImage: `url(${blog.image})` }" :aria-label="'View blog post: ' + blog.title"></router-link>
              </div>
              <div class="blog-details">
                ...
                <div class="blog-tags mt-2">
                  <span
                    ...
                    class="tag-badge"
                  >{{ tag }}</span>
                  <span v-if="(blog.tags || [blog.category]).length > 3" class="tag-badge">+{{ (blog.tags || [blog.category]).length - 3 }}</span>
                </div>
              </div>
              <div class="blog-actions ml-auto d-flex align-items-center">
                <router-link :to="'/blog/' + blog.id" class="btn btn-primary py-2 read-btn" aria-label="Read blog post">Read More</router-link>
              </div>
            </div>
          </div>
        </div>
